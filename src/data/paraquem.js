...
export const data = {
    "Reciclagem": {
      ...
      "texto": [
        ...
        "Além disso, a compactação automática dos resíduos recicláveis contribui para a otimização do espaço disponível, permitindo o armazenamento de um maior volume de materiais em menor área. Com o controle de enchimento em tempo real, os responsáveis pela gestão do local são alertados quando os recipientes atingem sua capacidade máxima, possibilitando uma coleta programada, econômica e eficiente.", 
        "Implementar o TrashTrack em centros de reciclagem é dar um passo à frente na profissionalização da gestão de resíduos. Trata-se de uma solução sustentável, prática e moderna, que fortalece a economia circular e eleva os padrões da reciclagem no Brasil e no mundo."
      ]
    },
    "Escritórios": {
      ...
      "texto": [
        ...
        "Além de contribuir para a preservação do meio ambiente, a presença do TrashTrack nos escritórios reforça o compromisso da empresa com a responsabilidade socioambiental, promovendo uma cultura organizacional mais consciente e engajada. Ele também ajuda a manter os espaços mais organizados, já que a compactação dos resíduos evita o acúmulo e facilita a limpeza diária.",
        "Com sensores que monitoram o nível de enchimento e emitem alertas quando a lixeira está cheia, o sistema também melhora a logística de coleta interna, otimizando o trabalho das equipes de manutenção e reduzindo custos operacionais.",
        "Incorporar o TrashTrack aos escritórios é transformar o local de trabalho em um ambiente mais sustentável, inteligente e alinhado aos valores de uma nova geração de empresas preocupadas com o futuro do planeta."
      ]  
    },
    "Lojas": {
      ...
      "texto":[ "Em lojas e estabelecimentos comerciais, o descarte de resíduos é uma atividade constante, seja no atendimento ao cliente, no recebimento de mercadorias ou nas embalagens utilizadas no dia a dia. O TrashTrack surge como uma solução moderna para transformar esse desafio em uma oportunidade de sustentabilidade, organização e economia operacional.",
        ...
        "Ao adotar o TrashTrack, as lojas mostram ao público que se preocupam com a sustentabilidade, agregando valor à marca e incentivando práticas conscientes entre consumidores e funcionários. É uma escolha estratégica que melhora o dia a dia da operação e fortalece a imagem do negócio frente a um mercado cada vez mais atento às questões ambientais."
      ]
    },
    "Hospitais": {
      ...
      "texto":[ "Em hospitais e unidades de saúde, o gerenciamento de resíduos exige rigor, organização e responsabilidade. O TrashTrack se torna um aliado estratégico nesse contexto, oferecendo uma solução automatizada que contribui para a separação correta de materiais recicláveis e otimiza a gestão dos resíduos comuns não contaminantes.",
        ...
        "Com o TrashTrack, hospitais podem alinhar suas práticas de descarte às normas ambientais, melhorar a organização interna e demonstrar um compromisso claro com a sustentabilidade, sem comprometer a segurança nem a eficiência do dia a dia hospitalar."
      ]
    },
    "Varejo": {
      ...
      "texto": [ "O setor varejista movimenta grandes volumes de produtos e, consequentemente, gera uma quantidade significativa de resíduos diariamente. Em meio a essa dinâmica intensa, o TrashTrack oferece uma solução tecnológica que contribui para a eficiência operacional e o compromisso ambiental de marcas que atuam diretamente com o público.",
        ...
        "Ao implementar o TrashTrack, empresas do varejo demonstram responsabilidade socioambiental, otimizam sua operação e elevam a imagem da marca perante um público cada vez mais atento às práticas sustentáveis."
      ]
    }
  }
